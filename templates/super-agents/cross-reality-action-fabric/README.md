...
- **Video — planned — recording + upload pending (target: super-agent-demos-v1 GitHub Release):** the recorded MP4 will live at
  [`https://github.com/AgentMindCloud/grok-agent/releases/download/super-agent-demos-v1/cross-reality-action-fabric-demo.mp4`](https://github.com/AgentMindCloud/grok-agent/releases/download/super-agent-demos-v1/cross-reality-action-fabric-demo.mp4)
