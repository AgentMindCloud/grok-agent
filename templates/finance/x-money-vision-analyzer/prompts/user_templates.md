...
> Built for xAI, X, Grok and the ecosystem community — these templates make Article II (consent gates), Article III (no silent contradictions, no unauthorized cross-tool writes), Article IV (provenance), and Article V (disclaimers) enforceable by construction inside every Grok call this engine makes.
